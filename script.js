...
fetch('https://exercisedb.p.rapidapi.com/exercises', options)
    ...
    .then(function(response) {
        ...
        welcomeMessage2.innerHTML = "Our Mission: "

		let welcomeMessage3 = document.createElement("h1");
        welcomeMessage3.innerHTML = "Fitness101 aims to tackle the issue of obesity and stop it from affecting more people. In the United States alone, 41.9% of adults have obesity. This can lead to shorter life spans and serious health concerns."

		let welcomeMessage4 = document.createElement("h1");
        welcomeMessage4.innerHTML = "Get started by choosing what muscle you want to workout, choosing what food you want to eat right now, or viewing some of our workout schedules! Start your Self-Imporvement Journey Today!"

        newDiv.className = 'welcomeMessage'
        newDiv.append(welcomeMessage, welcomeMessage2, welcomeMessage3, welcomeMessage4)
